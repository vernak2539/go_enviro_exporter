...
build_amd64:
	env GOOS=linux GOARCH=amd64 go build -o ./build/enviro_exporter-$(VERSION).linux-armv7 ./cmd/main.go

build_arm64:
	env GOOS=linux GOARCH=arm64 go build -o ./build/enviro_exporter-$(VERSION).linux-armv7 ./cmd/main.go
